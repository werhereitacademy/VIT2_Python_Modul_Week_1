# VIT2 Python-Module-Week1
- Soru 1: Kullanıcıdan bir sayı girişi alarak, 1'den kullanıcının girdiği sayıya kadar olan tüm çift sayıları ekrana yazdıran bir döngüsü nasıl oluşturulur? Bunu once for ile sonra while donguleri ile yapiniz
